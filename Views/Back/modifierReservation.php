...
if (
    ...
    if (
        ...
        $reservationC->modifierReservation($Reservation, $_GET['idres']);
        header('refresh:2;url=afficherReservation.php');
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            <label for="date">Entrer la date de reservation</label>
                        ...
                        <div class="form-group">
                            <label for="nombre">Entrer le nombre pour Reserver</label>
                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="1-2-3" required>
