        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="validModifierReservation.php?idres=<?PHP echo $_GET['idres']; ?>" id="form" onsubmit="return verif();>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="temps">Entrer le temps de reservation</label>
