...
include_once '../../Controller/platC.php';
    ...
    $platC = new platC();
    $listePlats = $platC->afficherPlatSansPromo();
...
if (
    ...
    if (
        ...
        echo "Pourcentage doit etre entre 0-100";
}
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <label for="nom">Entrer le nom de la promo</label>
                        ...
                        <div class="form-group">
                            <label for="description">Entrer le pourcentage</label>
                            <input type="text" class="form-control" name="pourcentage" id="pourcentage" placeholder="Pourcentage" min="1" max="99" required>
                        </div>
<div class="form-group">
                            Liste des plats
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button dis class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
