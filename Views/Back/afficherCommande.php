                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <?php
                            ...
                            $listeCommande = $commandeC->pagination($page, $perpage);
                        ...
                        <?PHP
                            ...
                            if(isset($_GET['recherche']))
                            {
                                ...
                                $listeCommande=$commandeC->recherche($search_value);
                            }
                        ?> 
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border=1 align='center'>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2">
                                        <form method="get" action="modifierCommande.php" >
                                            <input type="text" class="float-left" name="recherche" placeholder=" Taper l'ID de la commande">
                            ...
                            <tr class="table-primary">
                                ...
                                <td>
                                    <form method="POST" action="../../Controller/supprimerCommande.php">
