...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.php">Cuisinet<span>.com</span></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item <?php if($page == "Nous contacter"){echo 'active';}?>"><a href="contact.php" class="nav-link">Nous contacter</a></li>
                <?php 
				}
				else
				{ 
