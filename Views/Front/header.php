    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item <?php if($page == 'Réservation'){echo 'active';}?>"><a href="reservation.php" class="nav-link">Réservation</a></li>
				<?php  session_start(); ?>
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end justify-content-center">
				<div class="col-md-9 ftco-animate text-center mb-5">
					...
					<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Accueil <i class="fa fa-chevron-right"></i></a></span><?php echo "$page"; ?> <span><i class="fa fa-chevron-right"></i></span></p>
				</div>
			</div>
		</div>
</section>
